...
The graph generated by the program currently is not reflective of the magnitude of the charges specified by the user, treating the charges as equal magnitude.

## Installation

This python program requires the following dependencies:
